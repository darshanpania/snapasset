...
9. Provider redirects to Supabase callback
   URL: https://your-project.supabase.co/auth/v1/callback?code=...
   \u2193
   Supabase:
10. Exchange code for provider tokens\n 12. Get user info from provider
11. Create or update user account
12. Create session
13. Redirect to your app: http://localhost:5173/auth/callback
    \u2193
    AuthCallback Component:
14. Extract session from URL\n 17. Call supabase.auth.getSession()
15. Session established
    \u2193
    Frontend:
...
7. Show \"Check your email\" message
   ...
   User:
8. Check email\n 13. Click reset link
9. Redirected to /auth/reset-password
   \u2193
...
8. After login, redirect back (optional)
...
5. Return success
   \u2193
   AuthContext:
6. Clear user state (set to null)
7. Clear session state (set to null)
8. Trigger onAuthStateChange
   \u2193
   Frontend:
9. Update UI (remove user menu)
10. Show sign in/up buttons
11. Redirect to /auth/login (optional)
    \u2193
    Browser:
12. Clear localStorage session
13. User is now logged out
