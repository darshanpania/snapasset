...
describe('SupabaseStorageAdapter', () => {
  ...
  describe('upload', () => {
    ...
    it('throws when supabase upload returns an error', async () => {
      ...
      const buffer = Buffer.from('fake-image-data');
      await expect(adapter.upload('my-bucket', 'images/test.png', buffer)).rejects.toThrow(
        'Upload failed'
      );
    });
  });
  ...
  describe('delete', () => {
    ...
    it('throws when supabase remove returns an error', async () => {
      ...
      await expect(adapter.delete('my-bucket', 'images/old.png')).rejects.toThrow('Delete failed');
    });
  });
});
