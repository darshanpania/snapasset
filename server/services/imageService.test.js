...
describe('Image Service', () => {
  ...
  describe('generateImageWithDallE', () => {
    ...
    it('throws error when OpenAI not configured', async () => {
      ...
      await expect(imageService.generateImageWithDallE('Test')).rejects.toThrow(
    ...
    it('handles rate limit errors', async () => {
      ...
      await expect(imageService.generateImageWithDallE('Test')).rejects.toThrow(/rate limit/i);
    });
  });
  ...
  describe('downloadImage', () => {
    ...
    it('handles download errors', async () => {
      ...
      await expect(imageService.downloadImage('https://example.com/image.png')).rejects.toThrow(
  ...
  describe('processImage', () => {
    ...
    it('handles processing errors', async () => {
      ...
      await expect(imageService.processImage(Buffer.from('test'), 1080, 1080)).rejects.toThrow(
  ...
  describe('generateImagesFromPrompt', () => {
    it('generates and processes images for multiple presets', async () => {
      ...
      const result = await imageService.generateImagesFromPrompt('A beautiful landscape', [
        'instagram-post',
      ]);
    ...
    it('throws error for invalid presets', async () => {
      ...
      await expect(
        imageService.generateImagesFromPrompt('Test', ['invalid-preset'])
    ...
    it('filters out failed processing', async () => {
      ...
      const result = await imageService.generateImagesFromPrompt('Test', [
        'instagram-post',
        'twitter-post',
      ]);
